...
--rays_per_batch 2048 --gpus 0 --chunk_size 4096 --val_step 5000 --max_step 250001 --no_batching --use_perturb \
--learning_rate 5e-4 --lrate_decay 50000 --normalize_coordinates
...
--rays_per_batch 1024 --gpus 0 --chunk_size 4096 --val_step 5000 --max_step 250001 --no_batching \
--learning_rate 5e-4

# nerf dtu scene 65
python main.py ckpt/nerf_dtu_65 --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan65_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 0 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4

# nerf dtu scene 106
python main.py ckpt/nerf_dtu_106 --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan106_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 1 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4

# nerf dtu scene 118
python main.py ckpt/nerf_dtu_118_paper_re --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan118_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 1 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4

# nerf dtu scene 65 vanilla model
python main.py ckpt/nerf_dtu_65_vanilla_paper_re --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan65_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 0 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4 --use_vanilla --embed_multires_views 10


# nerf dtu scene 106 vanilla model
python main.py ckpt/nerf_dtu_106_vanilla_paper_re --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan106_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 1 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4 --use_vanilla --embed_multires_views 10

# nerf dtu scene 118 vanilla model
python main.py ckpt/nerf_dtu_118_vanilla_paper_re --model_type nerf --use_viewdirs --n_samples 64 --dataset_type nerfppdata \
 --dataset_name scan118_paper --n_importance 128 --use_perturb --lrate_decay 50000 \
--rays_per_batch 1024 --gpus 0 --chunk_size 2048 --val_step 5000 --max_step 150000 --no_batching \
 --learning_rate 5e-4 --use_vanilla --embed_multires_views 10